export default function TermsOfServicePage() {
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-white dark:bg-gray-800 shadow dark:shadow-gray-900/20 rounded-lg p-6 sm:p-8">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <div className="text-right text-gray-600 dark:text-gray-400 mt-12">
            <p>制定日：2025年7月23日</p>
